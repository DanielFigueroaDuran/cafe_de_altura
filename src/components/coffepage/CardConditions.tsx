...
const CardConditions = () => {
    return (
        <div className=" backgroundCoffe flex flex-col items-center py-12 px-[142px] gap-6 bg-cover bg-center bg-no-repeat w-full ">
            <h2 className='font-medium text-2xl leading-7 text-[#fff]'>Café con las mejores condiciones</h2>
