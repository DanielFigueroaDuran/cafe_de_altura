    ...
    return (
        <>
            <div className='flex items-center justify-between md:gap-2'>
                <div className="flex items-center justify-center gap-2 mg:gap-3 lg:gap-4">
                    <CartCounter minius={Minus} plus={Plus} product={product} quantity={quantity} key={id} />
                    <div className='flex flex-col gap-4 ' >
                        <div className='flex items-center justify-center' >
                            <div className="flex items-center">
                                <img className="w-10 h-10 lg:w-14 lg:h-14" src={img_url} alt="cafe" />
                                <div className="flex flex-col items-center justify-center">
                                    <p className="text-[#000000] text-sm font-semibold leading-4">
                                        {brand}
                                    </p>
                                    <p className="text-[#000000] hidden md:block  ">Paquete de café, 250 gr</p>
                                </div>
                            </div>
                        </div>
                    </div>
